...
configure<MixinExtension> {
    ...
    add(sourceSets["main"], "mixins.spartan.refmap.json")
}
        ...
        create("client") {
            ...
            properties(
                mapOf(
                    ...
                    "fml.coreMods.load" to "net.spartanb312.render.launch.FMLCoreMod",
    ...
    jar {
        manifest {
            attributes(
                ...
                "FMLCorePlugin" to "net.spartanb312.render.launch.FMLCoreMod",
                "MixinConfigs" to "mixins.spartan.json",
                "TweakClass" to "org.spongepowered.asm.launch.MixinTweaker",
                "TweakOrder" to 0,
                "ForceLoadAsMod" to "true",
                "LaunchClass" to "net.spartanb312.render.Spartan"
            )
        }
        from(
            library.map {
