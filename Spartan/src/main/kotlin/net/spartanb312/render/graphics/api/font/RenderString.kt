...
import net.spartanb312.render.graphics.api.font.glyph.CharInfo
import net.spartanb312.render.graphics.api.font.glyph.GlyphChunk
...
class RenderString(private val string: CharSequence) {
    ...
    private object Shader : DrawShader(
        "assets/spartan/shader/font/FontRenderer.vsh",
        "assets/spartan/shader/font/FontRenderer.fsh"
    ) {
