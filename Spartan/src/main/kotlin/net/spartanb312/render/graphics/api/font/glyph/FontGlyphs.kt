...
import net.spartanb312.render.features.manager.MainThreadExecutor.onMainThreadSuspend
import net.spartanb312.render.graphics.api.texture.GrayscaleMipmapTexture
import net.spartanb312.render.graphics.api.texture.TextureUtils.getAlpha
...
class FontGlyphs(
    ...
    private fun createTexture(byteArray: ByteArray, width: Int, height: Int): GrayscaleMipmapTexture =
        GrayscaleMipmapTexture(byteArray, width, height, 4).useTexture {
