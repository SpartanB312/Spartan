package net.spartanb312.render.graphics.impl.item.button
...
sealed class EffectButton(
    ...
    class RectWavePulseOffsetButton(
        ...
        private val effectFont = EffectText.Hoover(FontManager.infoFont)
    ...
    class MouseFollowOffsetButton(
        ...
        private var animatedAlphaRate = 0.0
        ...
        override fun onRender(mouseX: Int, mouseY: Int, partialTicks: Float) {
            ...
            animatedAlphaRate = if (isHoovered) animatedAlphaRate.converge(100.0, 0.1)
            else animatedAlphaRate.converge(0.0, 0.1)

            val adjustedAlphaRate = animatedAlphaRate / 100.0
            ...
            scissor(x.ceilToInt(), y.ceilToInt(), endX.floorToInt(), endY.floorToInt()) {
                ...
                //Background
                Legacy2DRenderer.drawRect(x, y, endX, endY, ColorRGB.WHITE.transparency(32, adjustedAlphaRate))

                //Circle
                GL_TRIANGLE_FAN.begin {
                    put(mouseX.toFloat(), mouseY.toFloat(), ColorRGB.WHITE.transparency(96, adjustedAlphaRate))
            ...
            effectFont.draw(
                ...
                scale = scale,
                shadow = false,
                baseColor = ColorRGB.WHITE.blend(0.862745098f, true),
                nextColor = ColorRGB.WHITE,
                speed = 0.045f,
                updateTime = 16
            )
        }
