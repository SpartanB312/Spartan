package net.spartanb312.render.graphics.impl.item.text
...
sealed class EffectText(
    protected val fontRenderer: AbstractFontRenderer,
    var action: (EffectText.(mouseX: Int, mouseY: Int, button: Int) -> Boolean)? = null,
) : SpecialItem {
    ...
    class Shining(
        ...
        action: (EffectText.(mouseX: Int, mouseY: Int, button: Int) -> Boolean)? = null,
    ) : EffectText(fontRenderer, action) {
